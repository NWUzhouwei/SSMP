...
def train(args):
        ...
        # attention = Attention(hidden_size=512, num_attention_heads=2)
        ...
        for epoch_idx in range(init_epoch, cfg.TRAIN.NUM_EPOCHS):
            ...
            if cfg.TRAIN.lr_decay:
                ...
                for param_group in encoder_solver.param_groups:
                    param_group['lr'] = lr
                print(f"Updated learning rate for encoder: {lr}")

                for param_group in decoder_solver.param_groups:
                    param_group['lr'] = lr
                print(f"Updated learning rate for decoder: {lr}")
            ...
            if cd < best_cd:
                file_name = cfg.DATASET.TRAIN_DATASET+'checkpoint-best-10'
                best_cd = cd
            ...
            if epoch_idx >100 and epoch_idx %40==0:
                file_name =  cfg.DATASET.TRAIN_DATASET+'checkpoint-last-10'
